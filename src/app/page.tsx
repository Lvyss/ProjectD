...
const TERRITORY_CENTERS_MOBILE: Record<string, { cx: string; cy: string }> = {
  'las-venturas':  { cx: '70%', cy: '25%' },
  'bone':          { cx: '48%', cy: '25%' },
  'tierra-robada': { cx: '30%', cy: '18%' },
  'san-fierro':    { cx: '28%', cy: '50%' },
  'red-county':    { cx: '73%', cy: '52%' },
  'whetstone':     { cx: '28%', cy: '80%' },
  'flint':         { cx: '49%', cy: '74%' },
  'los-santos':    { cx: '79%', cy: '76%' },
}
          ...
          {isMobile ? (
            ...
            <div style={{
              ...
              <div className="sixteen-nine-wrapper">
                <div style={{
                          ...
                          >
                            <div style={{
                              ...
                              <div style={{ display: 'flex', alignItems: 'baseline', gap: '5px' }}>
                                ...
                                <span style={{ fontSize: '0.55rem', color: '#ff3311', fontWeight: 'bold' }}>/</span>
                                <span className="territory-name" style={{
                                  ...
                                  letterSpacing: '0.1em',
                                  color: isActive ? '#ffffff' : 'rgba(255,255,255,0.4)',
                                }}>{territory.name.toUpperCase()}</span>
                              </div>
                              {isActive && <div style={{ width: '4px', height: '4px', borderRadius: '50%', background: '#00ff88', boxShadow: '0 0 8px #00ff88' }} />}
                            </div>
                            {topWinner ? (
                              <div style={{ paddingLeft: '16px', display: 'flex', gap: '4px', alignItems: 'center', flexWrap: 'wrap' }}>
                              ...
                              <div style={{ paddingLeft: '16px' }}><span style={{ fontSize: '0.5rem', color: '#555', fontStyle: 'italic' }}>— no data —</span></div>
                            )}
                          </div>
                        )
                      })}
                    </div>
                    <div style={{ paddingTop: '6px', borderTop: '1px solid rgba(255,255,255,0.04)', display: 'flex', justifyContent: 'space-between', fontSize: '0.45rem', color: '#fffaaa' }}>
                  ...
                  {/* RIGHT MAP MOBILE */}
                  <div style={{ width: '58%', position: 'relative', display: 'flex', alignItems: 'center', justifyContent: 'center', paddingRight: '10px' }} ref={mapRef}>
                    <div style={{ width: 'calc(100% - 10px)', height: 'calc(100% - 10px)', background: '#00000055' }}>
            ...
            <div style={{
              ...
              <div style={{
                ...
                <img src="/logo1.png" alt="PROJECT.D" style={{ maxWidth: '90%', height: 'auto', maxHeight: '350px', objectFit: 'contain' }} />
              </div>
                      ...
                      return (
                        ...
                        >
                          ...
                          {topWinner ? (
                            ...
                            <div style={{ paddingLeft: '32px' }}><span style={{ fontSize: '0.65rem', color: '#fff6', fontStyle: 'italic' }}>— no data —</span></div>
                          )}
                        </div>
                      )
                    })}
